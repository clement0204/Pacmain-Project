...
class GameEnding:
	...
	def __init__(
		...
		self.bg_loading = pygame.image.load('resources/images/background/menu.png')
	...
	def run(self):
		...
		while mainloop:
			...
			label = self.font.render('Merci d\'avoir joué !', 1, (255, 255, 255))
			self.screen.blit(label, (350,350))
